...
This one was pretty straightforward, just extracted changing values and checking conditions into functions to make them easier to work with.

## Part B

Added literally three lines of code.
